...
| GET | /api/flows/{flowId} | Flow詳細 |
| POST | /api/projects/{projectId}/flows | Flow作成 |
| PUT | /api/flows/{flowId} | Flow更新 |
| DELETE | /api/flows/{flowId} | Flow削除 |
| POST | /api/flows/{flowId}/lock | 編集ロック取得 |
| DELETE | /api/flows/{flowId}/lock | 編集ロック解除 |
