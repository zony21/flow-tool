...
| `12_16_ExportService設計.md` | Export Service | 詳細化済み |
| `12_17_VersionSnapshot設計.md` | Version Snapshot | 詳細化済み |
| `12_18_Validation設計.md` | Validation | 詳細化済み |
| `12_19_バックエンドテスト設計.md` | Backend Test | 詳細化済み |
| `12_20_バックエンド設計まとめ.md` | 総まとめ | 詳細化済み |
...
12章は `12_01`〜`12_20` まで詳細化済み。

12_バックエンド設計は詳細化済みとする。
次工程は `13_描画エンジン設計` の詳細化を想定する。
